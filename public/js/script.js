// Detecting Mobile Devices to Add Camera Toggle 
...
// Use Port 3000 for Local Host and 443 while Deploying for Socket Connections !
const socket = io("/");
const videoGrid = document.getElementById("video-grid");
const myPeer = new Peer(undefined, {
    path: "/peerjs",
    host: "/",
    port: "3000",  // port: "443", for deploying 
});
var Peer_ID;
...
//Zoom Video and Expand User Window 
...
// video toggle for Mobile Devices
...
// Detecting Mobile Devices for Camera Toggle 
